# -*- coding: utf-8 -*-
# 신입 OT (인사팀 안내 버전)
# Step2 25초 자동 트리거 + Step 간 10초 텀 + Step4 포럼 생성 안정화
...
OT_STEPS = {
    ...
    4: {
        ...
        "desc": (
            "━━━━━━━━━━━━━━━━━━━\n"
            "**매주 한번씩 자유롭게 스스로 피드백해보는 시간을 가져요 📅**\n\n"
            "‘#주간-그림보고’ 채널에 여러분만의 피드백 공간을 만들어줄게요!\n"
            "━━━━━━━━━━━━━━━━━━━\n"
...
async def trigger_step2_after_delay(user: discord.Member):
    ...
    await asyncio.sleep(STEP2_DELAY)  # Step2 메시지 이후 25초 대기
